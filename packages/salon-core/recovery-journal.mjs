...
export const recoverableOperations=Object.freeze(['customer_create','order_create','order_lines','order_status','cash_checkout','refund_review','cash_refund_request']);
