...
export const recoverableOperations=Object.freeze(['customer_create','order_create','order_lines','order_status','cash_checkout','checkout','refund_review','refund_withdraw','refund_stock_inspect','refund_channel_receipt','cash_refund_request','partial_cash_refund_request']);
