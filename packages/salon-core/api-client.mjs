...
const reads = new Set(['context', 'stores', 'customers', 'catalog', 'orders', 'order_detail', 'booking_requests', 'reschedule_requests', 'store_time', 'request_lookup', 'refund_queue', 'refund_detail', 'cash_refund_source', 'cash_refund_availability']);
const writes = new Set(['customer_create', 'order_create', 'order_lines', 'order_status', 'cash_checkout', 'booking_cancel_review', 'booking_reschedule', 'reschedule_review', 'refund_review', 'refund_withdraw', 'refund_stock_inspect', 'cash_refund_request', 'partial_cash_refund_request']);
