...
const writes = new Set(['customer_create', 'order_create', 'order_lines', 'order_status', 'cash_checkout', 'booking_cancel_review', 'booking_reschedule', 'reschedule_review', 'refund_review', 'cash_refund_request']);
