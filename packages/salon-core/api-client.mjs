...
const reads = new Set(['context', 'stores', 'customers', 'catalog', 'members', 'orders', 'order_detail', 'booking_requests', 'reschedule_requests', 'store_time', 'request_lookup', 'refund_queue', 'refund_detail', 'refund_channel_receipts', 'cash_refund_source', 'cash_refund_availability']);
const writes = new Set(['customer_create', 'order_create', 'order_lines', 'order_status', 'cash_checkout', 'checkout', 'booking_cancel_review', 'booking_reschedule', 'reschedule_review', 'refund_review', 'refund_withdraw', 'refund_stock_inspect', 'refund_channel_receipt', 'cash_refund_request', 'partial_cash_refund_request']);
