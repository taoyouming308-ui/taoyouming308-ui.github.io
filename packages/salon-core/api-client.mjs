...
const reads = new Set(['context', 'stores', 'customers', 'catalog', 'orders', 'order_detail', 'booking_requests', 'reschedule_requests', 'store_time', 'request_lookup', 'refund_queue', 'refund_detail', 'refund_channel_receipts', 'cash_refund_source', 'cash_refund_availability']);
