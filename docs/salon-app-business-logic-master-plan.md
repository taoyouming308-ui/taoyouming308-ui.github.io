...
| G06 | 已补未到店且未关联订单的取消复核及门店原子改期；新增顾客改期申请/门店复核数据库与 API，待确认保留原档期 | 新申请流程尚未接顾客/门店页面；仍需双身份浏览器闭环、门店时区、例外处理和通知；详见 salon-customer-reschedule-requests.md、salon-booking-cancel-review.md 与 salon-booking-reschedule.md |
