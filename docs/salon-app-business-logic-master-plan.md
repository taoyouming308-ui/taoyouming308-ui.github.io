...
| G06 | 已补取消复核、门店原子改期及顾客申请/门店复核；本机双端页面通过 HTTP/PG、手机和丢包重试验收 | 仍需正式顾客登录、门店时区、例外处理和通知；详见 salon-customer-reschedule-requests.md、salon-booking-cancel-review.md 与 salon-booking-reschedule.md |
