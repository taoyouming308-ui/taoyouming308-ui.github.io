...
| G06 | 已补未到店且未关联订单的取消复核及门店同手艺人/同时长原子改期，含版本防覆盖、本机页面和顾客查询结果 | 仍需顾客自助改期申请/确认、门店时区、例外处理、顾客页面和通知；详见 salon-booking-cancel-review.md 与 salon-booking-reschedule.md |
