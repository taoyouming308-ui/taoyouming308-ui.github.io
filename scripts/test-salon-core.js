...
const transactionSql=fs.readFileSync('supabase/migrations/20260906062903_salon_transaction_safety.sql','utf8');
const refundSql=fs.readFileSync('supabase/migrations/20260906063629_salon_refund_reversal.sql','utf8');
...
expect(transactionSql.includes('public.salon_checkout_order'),'atomic checkout migration missing');
expect(refundSql.includes('public.salon_refund_order'),'atomic refund migration missing');
