const OPERATIONS={
  ...
  booking_review:{rpc:'salon_review_customer_booking'},booking_cancel_review:{rpc:'salon_review_booking_cancel'},booking_requests:{rpc:'salon_list_customer_bookings'},
