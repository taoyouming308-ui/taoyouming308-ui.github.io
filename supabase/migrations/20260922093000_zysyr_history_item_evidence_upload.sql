-- ZYSYR v519: let finance append an exact image/PDF to any supported posted
-- historical item. The imported source and posted amount remain immutable.
...
comment on function public.zysyr_attach_history_ledger_evidence(
  uuid, uuid, uuid, uuid, text, text, bigint, text, text, text, text
) is 'Append exact evidence to one supported posted historical item without rewriting its source or amount.';
