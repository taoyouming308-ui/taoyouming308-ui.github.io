...
## v490 经营驾驶舱长期登录容错（2026-09-12，本地待发布）

- App version: v490。基于 GitHub main v489，只修复经营驾驶舱账号会话恢复与自动续期；尚未部署生产或推送 GitHub。
...
- 待完成：补足故障注入回归、完整发布门禁、部署 `operations-api`，再推送静态 v490 并验证匿名拒绝和线上缓存版本。
