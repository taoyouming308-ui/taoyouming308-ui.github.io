...
- v405 完整发布回归已通过：版本、发布、更新流程、前台运行时、预约、后台、客户档案、发质、护理、美感、28项美管加 Python 回归和 Agent 状态全部通过；线上函数空账号安全探针返回预期 403“请输入账号和密码”。GitHub Pages 线上核验待发布后完成，未改动未跟踪 `aesthetic-coach-edge.ts`。
- App version: v405
