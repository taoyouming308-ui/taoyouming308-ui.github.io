...
## v491 日报页面单一月份入口（2026-09-12，本地待发布）

- App version: v491。基于 GitHub main v490，只移除日报页面重复显示的第二个月份下拉框；尚未推送 GitHub 或发布线上。
- 保留顶部统一月份选择器以及日报区域的“上一月 / 下一月”按钮；按钮会同步更新顶部月份、日报查询月份和上传资料月份，不修改任何日报、月报或凭证数据。
- 待完成：日报静态回归、完整发布门禁、GitHub main 与 Pages 发布、CDN 无缓存核验。
