...
## v467 备用金逐笔原图追溯与历史原表差异核对（2026-08-31，待发布）
...
- 工资同口径核对发现 1–3 月工资原表“应发总计”与月报内嵌工资区存在原始表冲突，4–6 月一致；员工自购/零售与月报产品收入除 2 月差 ¥64 外其余月份一致。冲突保留原值并列入待人工确认，不强行改账。App version: v467
