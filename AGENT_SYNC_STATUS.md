...
## v484 月报财务一站式工作台与精确项目路由（2026-09-08，发布中）
...
- 隔离 PostgreSQL 已通过原数据不变、工资/公式支出调整、产品汇总与合计拒绝修改、单笔免凭证、RLS 和审计测试；浏览器回归覆盖电脑、手机竖屏、手机横屏以及产品明细直达。尚未应用生产迁移、未部署 Edge Function、未推送 GitHub main、未发布 GitHub Pages，也未写入生产财务数据。
