...
## v437 独立工资报表与备用金明细追溯（2026-08-26，本地候选未发布）
...
- 未新增数据库迁移；保留 v436/v435 两个本地待迁移文件。完整 pre-push 回归通过；本地 Chrome v437 财务视角已实际验证导航顺序、工资金额追溯、备用金日报行/原表行/凭证追溯，控制台无错误。当前仅本地实现，尚未部署 Edge Function、发布静态页面、提交或推送。
- App version: v437
