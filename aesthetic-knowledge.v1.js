    ...
    trainingFlow: [
      {
        ...
        name: '观察',
        english: 'Observe',
        question: '这是什么风格？有哪些画面证据？',
        rule: '先判断风格（甜美/酷感/优雅/自然/前卫/复古/极简/少年感），再用线条、量感、重心、色调、质感描述事实。不分析、不推测。',
        coachAction: '检查风格判断是否准确，主观感受是否误写成事实，并提醒遗漏的视觉元素。'
      },
      {
        id: 'analyze',
    ...
    trainingCases: [
      {
        ...
        guides: {
          observe: {
            prompts: ['🎨 先判断风格（八选一）+ 线条/量感/重心/色调/质感各写一个观察词', '先看外轮廓是什么形', '重量最集中在哪里', '发尾、耳周和后颈是什么状态', '只写画面事实，不写"适合、显瘦、高级"'],
      ...
      },
      {
        ...
        guides: {
          observe: {
            prompts: ['🎨 先判断风格（八选一）+ 线条/量感/重心/色调/质感各写一个观察词', '刘海和脸周有几组方向', '最宽点与最轻的位置在哪里', '曲线大小是否完全一致', '区分发型事实与模特气质'],
      ...
      },
      {
        ...
        guides: {
          observe: {
            prompts: ['🎨 先判断风格（八选一）+ 线条/量感/重心/色调/质感各写一个观察词', '头发占人物整体的面积', '刘海边界、耳周和后颈是否整齐一致', '哪里贴、哪里有轻微起伏', '色彩对比强还是弱'],
      ...
      },
      {
        ...
        guides: {
          observe: {
            prompts: ['🎨 先判断风格（八选一）+ 线条/量感/重心/色调/质感各写一个观察词', '外轮廓偏圆还是偏方', '刘海长度与边缘状态', '耳周有没有完全收紧', '顶部纹理的尺度'],
      ...
      },
      {
        ...
        guides: {
          observe: {
            prompts: ['🎨 先判断风格（八选一）+ 线条/量感/重心/色调/质感各写一个观察词', '轮廓线落在什么位置', '顶部体积高还是低', '脸周和后颈是否同一长度', '湿感如何影响束感与光泽'],
